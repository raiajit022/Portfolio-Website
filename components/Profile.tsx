    ...
    <aside className="md:w-80 flex flex-col items-center md:items-start gap-6">
      <div className="text-center md:text-left">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          <p>📍 Bengaluru</p>
          <a 
            href="https://www.linkedin.com/in/raiajit011/" 
      ...
      <div className="w-full space-y-4">
        <SkillSection title="Technical Skills" skills="MS Excel, Python, Power BI, SQL" />
        <SkillSection title="Soft Skills" skills="Problem Solving, Critical Thinking, Information Gathering" />
        <SkillSection title="Domain Knowledge" skills="Financial Statement Understanding, Business Analytics" />
        <SkillSection title="Languages" skills="Hindi, English" />
      </div>
    </aside>
  )
}